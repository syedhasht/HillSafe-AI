...
class LanguageProvider extends ChangeNotifier {
  ...
  static const Map<String, String> _ur = {
    ...
    'Project Explanation': 'منصوبے کی وضاحت',
    'HillSafe AI predicts landslide risk for mountainous regions of Pakistan. The mobile app sends location data to the Django backend, where weather and terrain signals are processed by the machine learning model.': 'ہل سیف AI پاکستان کے پہاڑی علاقوں میں لینڈ سلائیڈ کے خطرے کی پیش گوئی کرتا ہے۔ موبائل ایپ مقام کا ڈیٹا Django بیک اینڈ کو بھیجتی ہے، جہاں موسم اور زمینی معلومات کو مشین لرننگ ماڈل سے گزارا جاتا ہے۔',
    'Weather shows rainfall and temperature.': 'موسم بارش اور درجہ حرارت دکھاتا ہے۔',
    'Terrain explains slope, elevation, and soil.': 'زمینی معلومات ڈھلوان، بلندی اور مٹی کی حالت بتاتی ہیں۔',
    'The model combines these signals into Low, Moderate, or High risk.': 'ماڈل ان اشاروں کو ملا کر کم، درمیانہ یا زیادہ خطرہ بتاتا ہے۔',
    'FAQs': 'عام سوالات',
    'Ask about risk or safety': 'خطرے یا حفاظت کے بارے میں پوچھیں',
    'Send': 'بھیجیں',
    'Thinking...': 'سوچ رہا ہے...',
    'What is HillSafe AI?': 'ہل سیف AI کیا ہے؟',
    'HillSafe AI is a landslide early-warning app. It uses location, weather, terrain, and a machine learning model to estimate risk and guide residents.': 'ہل سیف AI لینڈ سلائیڈ کی پیشگی وارننگ دینے والی ایپ ہے۔ یہ مقام، موسم، زمین اور مشین لرننگ ماڈل سے خطرہ معلوم کر کے رہائشیوں کی رہنمائی کرتی ہے۔',
    'Why is my area risky?': 'میرا علاقہ خطرناک کیوں ہے؟',
    'Risk increases when rainfall is heavy, slopes are steep, soil is weak, elevation changes quickly, or the area has past landslide activity.': 'جب بارش زیادہ ہو، ڈھلوانیں تیز ہوں، مٹی کمزور ہو، بلندی تیزی سے بدلے یا علاقے میں پہلے لینڈ سلائیڈ ہو چکی ہو تو خطرہ بڑھ جاتا ہے۔',
    ...
    'Open Report, describe the incident, allow location access, and submit. The report is sent to the backend for authority review.': 'رپورٹ کھولیں، واقعہ بیان کریں، مقام کی اجازت دیں اور جمع کرائیں۔ رپورٹ حکام کے جائزے کے لیے بیک اینڈ کو بھیجی جاتی ہے۔',
